...
The astute among you will be aware that I'm working on [Passerine](https://www.passerine.io/), a little programming language of sorts. I've written enough about it [pretty](https://github.com/vrtbl/passerine#an-overview) [much](https://codex.passerine.io) [everywhere](/passerine/) [else](/passerine/all-you-need/), so if you need a quick refresher, click the... clickable things.
